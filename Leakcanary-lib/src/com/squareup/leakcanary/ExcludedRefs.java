...
/**
 * Prevents specific references from being taken into account when computing the
 * shortest strong reference path from a suspected leaking instance to the GC
 * roots. This class lets you ignore known memory leaks that you known about. If
 * the shortest path matches {@link ExcludedRefs}, than the heap analyzer should
 * look for a longer path with nothing matching in {@link ExcludedRefs}.
 */
